...
times1 = conj2sso(body1='moon', body2='4', t1=t1, t2=t2, maxval=10, kernels=kernels)
...
times2 = conj2sso(body1='moon', body2='2', t1=t1, t2=t2, maxval=10, kernels=kernels)
...
for i in times1:
    t1start, t1end = i[0], i[1]
    for j in times2:
        t2start, t2end = j[0], j[1]
        if time_intersection(t1start, t1end, t2start, t2end):
            print('t1start:', t1start)
            print('t1end  :', t1end)
